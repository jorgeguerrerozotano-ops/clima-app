...
const RouteFavorites = ({ onSelect }) => {
    ...
    const startEdit = (index) => {
        ...
        setEditName(place ? place.name : (index === 0 ? t('routes.house') : (index === 1 ? t('routes.work') : t('routes.place'))));
    ...
    const handleMapConfirm = async (coords) => {
        ...
        try {
            ...
            setTempLocation({
                ...
                lat: coords.lat,
                lon: coords.lon,
                address: t('routes.selectedOnMap')
            });
        }
    };
    ...
    return (
        <div className="mb-4">
            ...
            <p className="text-[9px] text-slate-500 mt-1 text-center italic">{t('routes.holdToEdit')}</p>
